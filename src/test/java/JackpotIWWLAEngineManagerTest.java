...
public class JackpotIWWLAEngineManagerTest
{
	...
	{
		logger = Logger.getLogger(JackpotIWWLAEngineManagerTest.class);
		logger.setLevel(Level.DEBUG);
		gameParams = XMLUtil.parseResource("paymodel/JackpotIWIW/GameParams.xml").getDocumentElement();
		previousOutcome = XMLUtil.parseResource("paymodel/JackpotIWIW/InitOutcome.xml").getDocumentElement();
